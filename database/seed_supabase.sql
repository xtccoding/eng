...
'["listening", "academic", "science"]', true),
...
'["speaking", "introduction", "daily"]', true),
...
'["speaking", "hometown", "description"]', true),
...
'["speaking", "interview", "business"]', true),
...
'["reading", "education", "benefits"]', true),
...
'["reading", "science", "space", "mars"]', true),
...
'["reading", "culture", "history", "coffee"]', true),
...
'["writing", "essay", "environment"]', true),
...
assets - 资产
liabilities - 负债',
'["vocabulary", "business", "professional"]', true),
...
perspective - 视角
phenomenon - 现象',
'["vocabulary", "academic", "writing"]', true),
...
'["speech", "education", "motivation"]', true),
...
'["speech", "technology", "society"]', true),
...
'["ielts", "reading", "urbanization"]', true),
...
'["article", "climate", "environment"]', true);
