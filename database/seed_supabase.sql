...
ARRAY['listening','daily','museum'], true),
...
ARRAY['listening','weather','news'], true),
...
ARRAY['listening','academic','science'], true),
...
ARRAY['speaking','introduction','daily'], true),
...
ARRAY['speaking','hometown','description'], true),
...
ARRAY['speaking','interview','business'], true),
...
ARRAY['reading','education','benefits'], true),
...
ARRAY['reading','science','space','mars'], true),
...
ARRAY['reading','culture','history','coffee'], true),
...
ARRAY['writing','daily','routine'], true),
...
ARRAY['writing','letter','friend'], true),
...
ARRAY['writing','essay','environment'], true),
...
assets - 资产
liabilities - 负债',
ARRAY['vocabulary','business','professional'], true),
...
perspective - 视角
phenomenon - 现象',
ARRAY['vocabulary','academic','writing'], true),
...
excursion - 短途旅行
check-in - 登记入住/办理登机',
ARRAY['vocabulary','travel','daily'], true),
...
ARRAY['speech','education','motivation'], true),
...
ARRAY['speech','technology','society'], true),
...
ARRAY['ielts','reading','urbanization'], true),
...
ARRAY['article','AI','technology'], true),
...
ARRAY['article','climate','environment'], true);
